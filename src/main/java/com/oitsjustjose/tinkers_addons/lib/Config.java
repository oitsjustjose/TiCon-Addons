...
public class Config
{
    ...
    void initialize()
    {
        ...
        property = config.get(Configuration.CATEGORY_GENERAL, "Enable Amelioration Kit mod for tools", true)
        ...
        property = config.get(Configuration.CATEGORY_GENERAL, "Enable 1st bonus modifier mod for tools", true)
                .setRequiresMcRestart(true);
        ...
        property = config.get(Configuration.CATEGORY_GENERAL, "Enable 2nd bonus modifier mod for tools", true)
                .setRequiresMcRestart(true);
        ...
        property = config.get(Configuration.CATEGORY_GENERAL, "Enable 3rd bonus modifier mod for tools", true)
                .setRequiresMcRestart(true);
        ...
        property = config.get(Configuration.CATEGORY_GENERAL, "Enable 4th bonus modifier mod for tools", true)
                .setRequiresMcRestart(true);
